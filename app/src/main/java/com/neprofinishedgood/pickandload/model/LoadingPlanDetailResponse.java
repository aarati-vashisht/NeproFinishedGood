...
public class LoadingPlanDetailResponse {

    @SerializedName("LoadingPlanList1")
    @Expose
    private List<LoadingPlanList1> loadingPlanList1 = null;
    ...
    public List<LoadingPlanList1> getLoadingPlanList1() {
        return loadingPlanList1;
    }

    public void setLoadingPlanList1(List<LoadingPlanList1> loadingPlanList1) {
